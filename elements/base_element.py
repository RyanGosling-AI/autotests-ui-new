...
class BaseElement:
    ...
    def click(self, nth: int = 0, **kwargs):
        step = f'Clicking {self.type_off} "{self.name}'
    ...
    def check_visible(self, nth: int = 0, **kwargs):
        step = f'Checking that {self.type_off} "{self.name}" is visible'
    ...
    def check_have_text(self, text: str, nth: int = 0, **kwargs):
        step = f'Checking that {self.type_off} "{self.name}" has text "{text}"'
